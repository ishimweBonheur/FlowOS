  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
      <section className="grid gap-8 lg:grid-cols-[1fr_0.95fr]">
        <div className="rounded-[2.5rem] border border-white/10 bg-slate-950/60 p-10 lg:p-16">
        ...
        <GlassCard className="p-8">
          <div className="space-y-4">
            <input className="w-full rounded-2xl border border-white/10 bg-slate-900/70 px-4 py-3 text-white outline-none" placeholder="Name" />
            <input className="w-full rounded-2xl border border-white/10 bg-slate-900/70 px-4 py-3 text-white outline-none" placeholder="Email" />
            <textarea className="min-h-36 w-full rounded-2xl border border-white/10 bg-slate-900/70 px-4 py-3 text-white outline-none" placeholder="Tell us about your team" />
