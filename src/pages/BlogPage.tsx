        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <GlassCard className="p-8" hover>
            ...
            <div className="mt-6 flex items-center gap-4 text-sm text-slate-400">
              ...
              <span className="rounded-full border border-white/10 bg-white/5 px-3 py-1">Strategy</span>
            </div>
          </GlassCard>
            ...
            {posts.map((post) => (
              <GlassCard key={post.title} className="p-6" hover>
                <div className="flex items-center justify-between gap-4">
                  ...
                  <a href="/blog" className="rounded-full border border-white/10 bg-white/5 p-3 text-slate-200">
                    <ArrowRight size={16} />
                  </a>
                </div>
